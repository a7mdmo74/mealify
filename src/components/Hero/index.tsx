import { BikeDelivery, HeroBg } from "@/lib/static";
import Image from "next/image";
import StaticsImages from "./StaticsImages";
import { data } from "@/lib/showcaseStatic";

const Hero = () => {
  return (
    <section id="hero" className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full">
      {/* Left */}
